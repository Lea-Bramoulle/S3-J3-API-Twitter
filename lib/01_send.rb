...
i = 0
  ...
  while i < x[0].size
    ...
    client.update("Bonjour #{x[0][i]}, pardonnez moi de vous déranger, mais pensez-vous qu'il est primordial de dire Bonjour à autrui ? #bonjour_monde @the_hacking_pro")
    i = i + 1
